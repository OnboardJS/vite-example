  ...
  return (
    <div className={cn("flex flex-col", className)}>
      <div className="flex flex-col items-center gap-2 text-center">
        <h1 className="text-2xl font-bold mb-3">You're good to go</h1>
        <p className="text-muted-foreground w-[640px] max-w-[90vw] mb-8 text-sm">
        ...
        <div className="max-w-[90vw] w-[900px] border border-input rounded-lg bg-accent/20 text-left flex max-sm:flex-col items-stretch justify-stretch">
